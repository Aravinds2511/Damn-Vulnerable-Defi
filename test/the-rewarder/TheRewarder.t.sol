...
contract TheRewarderChallenge is Test {
    ...
    function test_theRewarder() public checkSolvedByPlayer {
        ...
        uint dvtTxCount = (TOTAL_DVT_DISTRIBUTION_AMOUNT -
            ALICE_DVT_CLAIM_AMOUNT) / player_dvt_amount;
        uint wethTxCount = (TOTAL_WETH_DISTRIBUTION_AMOUNT -
            ALICE_WETH_CLAIM_AMOUNT) / player_weth_amount;
        ...
        console.log("dvt balance: ", dvt.balanceOf(player));
        console.log("weth balance: ", weth.balanceOf(player));
